...
class GruposControllerTest < ActionController::TestCase
  ...
  test "should create grupo" do
    assert_difference('Grupo.count') do
      post :create, grupo: { idAlmacen: @grupo.idAlmacen, idBanco: @grupo.idBanco, idGrupo: @grupo.idGrupo, nGrupo: @grupo.nGrupo }
    end
  ...
  test "should update grupo" do
    patch :update, id: @grupo, grupo: { idAlmacen: @grupo.idAlmacen, idBanco: @grupo.idBanco, idGrupo: @grupo.idGrupo, nGrupo: @grupo.nGrupo }
    assert_redirected_to grupo_path(assigns(:grupo))
  end
